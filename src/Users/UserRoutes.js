...
const {signUpUser, signInUser, validateUserSession} = require ('./UserFunctions'); // import functions form UserFunctions file
...
routes.post('/sign-up', async (request, response) => {
    ...
    // Hand data to a sign-up function // call signUpUser and pass in an object
